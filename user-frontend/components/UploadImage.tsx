...
export const UploadImage=({onImageAdded, image}:{
    ...
    async function onFileAdded(e:any){
        ...
        try{
            ...
            const response = await axios.get(`${BACKEND_URL}/v1/user/generatepresignedURL`,{
                headers:{
    ...
    return <div>
        <div className="w-36 h-36 border flex justify-center items-center">
                {uploading? <div role="status">
                    ...
                    <input type="file" className="opacity-0 w-36 h-36 absolute cursor-pointer " onChange={onFileAdded}/>
