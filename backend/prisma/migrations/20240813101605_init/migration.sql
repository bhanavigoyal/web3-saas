...
-- AddForeignKey
ALTER TABLE "Submission" ADD CONSTRAINT "Submission_optoin_id_fkey" FOREIGN KEY ("optoin_id") REFERENCES "Option"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
